...
def find_image(item_id, base_folder="."):
    ...
    print(f"Warning: Could not find any image for '{item_id}' in your folders.")
    return None
...
if len(random_outfit) < 3:
    print("Warning: Couldn't find enough clothes to make a full outfit. Check your folders!")
else:
