...
occasion_rules = {
    ...
    "family dinner": ["TOP_12", "BOT_10", "TOP_11", "TOP_03", "TOP_04", "TOP_09", "BOT_03", "SHO_03", "OUT_01"],
    "casual": ["BOT_10", "SHO_03", "TOP_02", "TOP_06", "TOP_13", "TOP_12", "TOP_11", "BOT_11", "TOP_08", "TOP_14", "SHO_07", "SHO_06", "BAG_03", "BAG_06"],
    "gym": ["TOP_02", "TOP_13", "BOT_05", "BOT_08", "BOT_09", "SHO_03", "SHO_08", "BAG_02"], 
...
# add if rule for raincoat and rain boots etc.
# add outerwear later as well
# add rule for sunglasses
